...
@section('scripts')
    ...
    <script>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, row, dataIndex)  {
                        ...
                        console.log(data);
                        return '<div class="form-outline">\n' +
                            '  <input type="number" id="quantity_'+data['actions']['id']+'" class="form-control" oninput="calculateRowAmount('+data['actions']['id']+')"  value="'+ data['quantity']+'" />\n' +
                            '</div>'
                    }
                },
                {
        ...
        $('#deleteModal').on('show.bs.modal', function (e) {
            ...
            $(e.currentTarget).find('#deleteForm').attr('action', 'dash/purchases/' + user_id);
        });
            ...
            if($('#fac_date').val()){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        window.location.href = "{{URL('dash/purchases')}}";
...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">purchases <span class="d-block text-muted pt-2 font-size-sm">Be careful</span>
                    </h3>
                </div>
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    @can('list-user')
                                        <li class="navi-item">
                                            <a href="dash/purchases/export" class="navi-link">
                                                <span class="navi-icon">
            ...
            <div class="card-body">
                ...
                <form id="deleteMultiForm" action="dash/purchases/delete-multi" method="post">
                @csrf
                <!--begin: Datatable-->
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalFormTitle"
             aria-hidden="true" style="display: none;">
            <div class="modal-dialog" role="document">
                <form id="deleteForm" action="dash/purchases/{id}" method="post">
                    @csrf
                    @method('delete')
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Price* :</label>
                                <input type="text" id="product_price" name="price"  value="{{old('price',count($products)> 0 ? $products[0]->price : 0)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <input type="text" id="product_quantity" name="quantity" value="{{old('quantity',count($products)> 0 ? $products[0]->quantity : 0)}}" autocomplete="given-name"
        ...
        <div class="modal fade" id="deleteMultiModal" tabindex="-1" aria-labelledby="exampleModalFormTitle"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalFormTitle">Do you really want to delete these purchases
                            ?</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">

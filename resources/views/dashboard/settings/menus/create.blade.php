...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="post" action="dash/menus">
                @csrf
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label>Name:</label>
                        <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter menu name" required/>
                        <span class="form-text text-muted">Please enter the menu's name</span>
                    </div>
                    <div class="form-group">
                        <label>Url:</label>
                        <input type="text" name="url" class="form-control form-control-solid" placeholder="Enter menu url" required/>
                        <span class="form-text text-muted">Please enter the menu's url</span>
                    </div>
                    <div class="form-group">
                        <label>Permissions:</label>
                        <input type="text" name="permissions" class="form-control form-control-solid" placeholder="Enter menu permissions" required/>
                        <span class="form-text text-muted">Please enter the menu's permissions</span>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6 col-sm-12">
                            <label>Icon:</label>
                            <input type="text" name="icon" class="form-control form-control-solid" placeholder="Enter menu icon" required/>
                            <span class="form-text text-muted">Please enter the menu's icon</span>
                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                            <label>Order:</label>
                            <input type="number" name="order" class="form-control form-control-solid" placeholder="Enter menu order" required/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-primary">
                                <label>
                                    <input type="checkbox" name="isSection" value="1" />
                                    <span></span>
                                </label>
                            </span>
                        </div>
                ...
                <div class="card-footer d-flex justify-content-end">
                    ...
                    <a href="dash/menus" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
            <!--end::Form-->
        </div>

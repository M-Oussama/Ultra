...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="post" action="dash/products" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 row">
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Barcode* :</label>
                                <input type="text" name="barcode" value="{{old('Barcode')}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>price :</label>
                                <input type="text" name="price" value="{{old('price')}}" autocomplete="price"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <input type="text" name="quantity" value="{{old('Quantity')}}" autocomplete="Quantity"
                            ...
                            <label class="col-3 col-form-label">Stackable:</label>
                                <div class="col-3">
                                    <span class="switch switch-lg switch-icon">
                                        <label>
                                            <input type="checkbox" checked="checked" name="stackable"/>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>

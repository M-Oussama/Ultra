        ...
        function addProduct(){
            ...
            if(!productExists(product)){
                ...
                $('#kt_datatable').DataTable().row.add([
                    ...
                    quantity,
                    montant,
                    '<a href="dash/clients/' + product['id'] + '/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">'+
                    ...
                    '</span>'+
                    '</a>'+
                    '<a href="#" data-toggle="modal"  data-target="#deleteModal" data-user_id="' + product['id'] + '" data-user_name="' + product['name'] + '" class="btn btn-sm btn-clean btn-icon" title="Delete">'+
                    '<span class="svg-icon svg-icon-md">'+
                    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">'+
                    '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">'+
                    '<rect x="0" y="0" width="24" height="24"/>'+

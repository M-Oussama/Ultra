        ...
        table.DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '\
                        \<a href="dash/products/' + row.id + '/pdf" class="btn btn-sm btn-clean btn-icon" title="PDF">\
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">Profits<span class="d-block text-muted pt-2 font-size-sm">Be careful</span>
                    </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Dropdown-->
                    @canany(['delete-product','list-product'])
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    @can('list-user')
                                        <li class="navi-item">
                                            <a href="dash/profits/export" class="navi-link">
                                                <span class="navi-icon">
                    ...
                    <!--begin::Button-->
                    @can('create-user')
                        <a href="dash/profit/create" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">

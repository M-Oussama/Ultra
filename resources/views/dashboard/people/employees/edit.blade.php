...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="post" action="dash/employees/{{$employee->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="image-input image-input-empty image-input-outline d-contents" id="kt_avatar"
                                ...
                                <div class="image-input-wrapper" style="background-image: url({{ !empty($employee->getFirstMedia('avatars')) ? $employee->getFirstMedia('avatars')->getUrl() : '' }})"></div>

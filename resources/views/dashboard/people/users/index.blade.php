...
@section('scripts')
    ...
    <script>
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        @canany(['edit-user','delete-user'])
                            @can('edit-user')
                            <a href="dash/users/' + row.id + '/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
        ...
        $('#deleteModal').on('show.bs.modal', function (e) {
            ...
            $(e.currentTarget).find('#deleteForm').attr('action', 'dash/users/' + user_id);
        });
    ...
    <div class="container">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">Users <span class="d-block text-muted pt-2 font-size-sm">Be careful</span>
                    </h3>
                </div>
                <div class="card-toolbar">
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    @can('list-user')
                                        <li class="navi-item">
                                            <a href="dash/users/export" class="navi-link">
                                                <span class="navi-icon">
                    ...
                    <!--begin::Button-->
                    @can('create-user')
                        <a href="dash/users/create" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
            ...
            <div class="card-body">
                <form id="deleteMultiForm" action="dash/users/delete-multi" method="post">
                @csrf
                <!--begin: Datatable-->
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalFormTitle"
            ...
            <div class="modal-dialog" role="document">
                <form id="deleteForm" action="dash/users/{id}" method="post">
                    @csrf
                    @method('delete')
        ...
        <div class="modal fade" id="deleteMultiModal" tabindex="-1" aria-labelledby="exampleModalFormTitle"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalFormTitle">Do you really want to delete these users
                            ?</h5>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">

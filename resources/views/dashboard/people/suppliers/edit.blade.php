...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="post" action="dash/suppliers/{{$supplier->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 row">
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Name* :</label>
                                <input type="text" name="name" value="{{old('name',$supplier->name)}}" autocomplete="family-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Surname* :</label>
                                <input type="text" name="surname" value="{{old('surname',$supplier->surname)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Email* :</label>
                                <input type="email" name="email" autocomplete="email" value="{{old('email',$supplier->email)}}"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <select class="form-control" id="kt_select2_1" name="type">
                                    @foreach($types as $type)
                                        <option value="{{$type->id}}"  {{$supplier->type_id == $type->id ? 'selected':''}}>{{$type->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

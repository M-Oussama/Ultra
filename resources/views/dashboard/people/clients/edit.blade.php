...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form class="form" method="post" action="dash/clients/{{$client->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 row">
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Name* :</label>
                                <input type="text" name="name" value="{{old('name',$client->name)}}" autocomplete="family-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label>Surname* :</label>
                                <input type="text" name="surname" value="{{old('surname',$client->surname)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <input type="text" name="sold" value="{{old('sold',$client->sold)}}" autocomplete="given-name"
                        ...
                        <div class="col-sm-12 col-md-12 row">
                            ...
                            <div class="form-group col-sm-6 col-md-6">
                                <label>N°RC* :</label>
                                <input type="text" name="nrc" value="{{old('NRC',$client->NRC)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-6 col-md-6">
                                <label>N°IF* :</label>
                                <input type="text" name="nif" value="{{old('NIF',$client->NIF)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-6 col-md-6">
                                <label>N°ART* :</label>
                                <input type="text" name="nart" value="{{old('NART',$client->NART)}}" autocomplete="given-name"
                            ...
                            <div class="form-group col-sm-6 col-md-6">
                                <label>N°IS* :</label>
                                <input type="text" name="nis" value="{{old('NIS',$client->NIS)}}" autocomplete="given-name"

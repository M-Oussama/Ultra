                ...
                var custom = calendar.publiclyTrigger('eventRender', [
                    {
                        ...
                        isStart: seg.isStart,
                        isEnd: seg.isEnd,
                        // TODO: include seg.range once all components-dashboard consistently generate it
                        el: seg.el,
                        view: view
                    }
                ]);
...
(function (global, factory) {
    ...
    */
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        ------------------------------------------------------------------------------------------------------------------*/
        // Builds the HTML skeleton for the view.
        // The day-grid and time-grid components-dashboard will render inside containers defined by this HTML.

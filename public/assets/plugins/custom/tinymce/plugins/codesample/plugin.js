    ...
    (function (define, exports, module, require) {
      ...
      (function (f) {
        ...
        return function () {
          ...
          14: [
            function (require, module, exports) {
              var Prism = require('prismjs/components-dashboard/prism-core');
              require('prismjs/components-dashboard/prism-clike');
              require('prismjs/components-dashboard/prism-markup-templating');
              require('prismjs/components-dashboard/prism-c');
              require('prismjs/components-dashboard/prism-cpp');
              require('prismjs/components-dashboard/prism-csharp');
              require('prismjs/components-dashboard/prism-css');
              require('prismjs/components-dashboard/prism-java');
              require('prismjs/components-dashboard/prism-javascript');
              require('prismjs/components-dashboard/prism-markup');
              require('prismjs/components-dashboard/prism-php');
              require('prismjs/components-dashboard/prism-python');
              require('prismjs/components-dashboard/prism-ruby');
